...
<input type="text" class="form-control" name="user" required></div><br>
...
<input type="number" class="form-control" name="phone" required></div><br>
...
<input type="text" class="form-control" name="qualification" required></div><br>

<div class="Form-group">
<label for="experience">experience</label>
<input type="text" class="form-control" name="experience" required></div><br>


<div class="Form-group">
<label for="about">about</label>
<input type="text" class="form-control" name="about" required></div><br>
...
<td><a href="deleteforStudent.php?id=<?php echo $row['id'] ?>">delete</a></td>
<td><a href="editforStudent.php?id=<?php echo $row['id'] ?>">edit</a></td>
</tr>
...
<td><?php echo $row['experience']; ?></td>
<td><?php echo $row['about']; ?></td>
<td><a href="deleteforTeacher.php?id=<?php echo $row['id'] ?>">delete</a></td>
<td><a href="editforTeacher.php?id=<?php echo $row['id'] ?>">edit</a></td>
